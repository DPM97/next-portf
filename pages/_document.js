    ...
    return (
      <Html lang={this.props.lang}>
        <Head>
          ...
          <link href='/favicon-16x16.avif' rel='icon' type='image/png' sizes='16x16' />
          <link href='/favicon-32x32.avif' rel='icon' type='image/png' sizes='32x32' />
          <link rel="apple-touch-icon" href="/apple-touch-icon.avif"></link>
        </Head>
        <body>
          <Main />
          <NextScript />
